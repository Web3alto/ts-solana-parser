...
console.log(`  jsonParsed: swapType=${a?.swapType} pool=${a?.pool?.slice(0, 8)}... input=${a?.inputAmount}`);
console.log(`  json:       swapType=${b?.swapType} pool=${b?.pool?.slice(0, 8)}... input=${b?.inputAmount}`);
console.log(`  base64:     swapType=${c?.swapType} pool=${c?.pool?.slice(0, 8)}... input=${c?.inputAmount}`);
console.log();
